...
export const OrbitingAtomsBackground: React.FC = React.memo(() => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden bg-gradient-to-br from-gray-950 via-purple-950/10 to-gray-950">
