...
export const ParticleFieldBackground: React.FC = React.memo(() => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden bg-gradient-to-br from-violet-950/20 via-black to-purple-950/20">
