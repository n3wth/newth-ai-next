...
;(self.webpackChunknewth_ai_next = self.webpackChunknewth_ai_next || []).push([
  [91],
  {
    ...
    './stories/4-animations/Meteors.stories.tsx': (
      ...
      const Meteors_Meteors = ({ number = 20, className }) => {
        const meteors = (0, react.useMemo)(
          () =>
      ...
      try {
        ;((Meteors_Meteors.displayName = 'Meteors'),
          (Meteors_Meteors.__docgenInfo = {
            description: '',
            displayName: 'Meteors',
            props: {
              number: {
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES['components/Meteors.tsx#Meteors'] = {
              docgenInfo: Meteors_Meteors.__docgenInfo,
              name: 'Meteors',
              path: 'components/Meteors.tsx#Meteors',
            }))
      } catch (__react_docgen_typescript_loader_error) {}
      const Meteors_stories = {
          title: 'Effects/Animations/Meteors',
          component: Meteors_Meteors,
          parameters: {
            layout: 'fullscreen',
        ...
        Default = {
          render: () =>
            (0, jsx_runtime.jsx)('div', {
              ...
              children: (0, jsx_runtime.jsx)(Meteors_Meteors, {}),
            }),
        },
        FewMeteors = {
          render: () =>
            (0, jsx_runtime.jsx)('div', {
              className: 'relative w-full h-screen bg-black overflow-hidden',
              children: (0, jsx_runtime.jsx)(Meteors_Meteors, { number: 5 }),
            }),
        },
        ManyMeteors = {
          render: () =>
            (0, jsx_runtime.jsx)('div', {
              className: 'relative w-full h-screen bg-black overflow-hidden',
              children: (0, jsx_runtime.jsx)(Meteors_Meteors, { number: 30 }),
            }),
        },
        WithContent = {
          render: () =>
            (0, jsx_runtime.jsxs)('div', {
              ...
              children: [
                (0, jsx_runtime.jsx)(Meteors_Meteors, { number: 10 }),
                (0, jsx_runtime.jsx)('div', {
