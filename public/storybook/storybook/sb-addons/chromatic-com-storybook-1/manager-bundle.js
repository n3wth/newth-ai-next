try {
  ;(() => {
          ...
          update(f) {
            ...
            if (E === l) {
              ...
              for (let [be, { color: wt }] of eo(p)) {
                let ge = v[+be]
                ;(JSON.stringify(n) !== JSON.stringify(V) && ge.style.setProperty('--bgc', wt),
                  C !== o && ge.style.setProperty('--br', y(C, g()) ? '50%' : '0'),
                  M !== d && (d && ge.classList.remove(d), M && ge.classList.add(M)))
              }
            } else ce = !0
            ;(c && !fe && clearTimeout(b),
    ...
    function Hr(
      ...
      return (
        M && (f[1] = v[b] ? v[b] : Vr.fullform[u][b] + (t ? 'bit' : yd) + (f[0] === 1 ? '' : 's')),
    ...
    var Md = Object.create,
      ...
      Ui = At((e, t) => {
        ;(function (n, r) {
          typeof Zd == 'function' && typeof e == 'object' && typeof t == 'object'
            ? (t.exports = r())
    ...
    function y5(e, t, n) {
      if (typeof e == 'number' && typeof t == 'number' && typeof n == 'number') return Va(e, t, n)
    ...
    function vi(e, t, n, r) {
      if (typeof e == 'string' && typeof t == 'number') {
        ...
        if (
          ...
          return r >= 1 ? gi(e, t, n) : 'rgba(' + e + ',' + t + ',' + n + ',' + r + ')'
        if (typeof e == 'object' && t === void 0 && n === void 0 && r === void 0)
          return e.alpha >= 1
    ...
    var as = Ct({ from: { transform: 'rotate(0deg)' }, to: { transform: 'rotate(360deg)' } }),
        ...
        return (
          e
            ...
            : n
              ...
              : ((s['aria-label'] = t),
                (o = a.createElement(Z5, { size: r, 'aria-hidden': 'true' }, t.substring(0, 1)))),
    ...
    var P5 = k.label((e) => ({
      ...
      j5 = k.div((e) => ({
        ...
        '> svg': {
          ...
          ...(e.error && { animation: `${F5} 700ms ease-out`, path: { fill: P.red } }),
        },
      })),
      z5 = k.div(
        (e) =>
    ...
    var os = W(({ type: e, startFocused: t, ...n }, r) => {
      ...
      return (
        ...
        a.createElement(ls, { ref: d, startingType: e, type: i, onActionClick: o, ...n })
      )
    })
    ...
    var G5 = k.div(
      ...
      Ki = ({ active: e, activeColor: t, disabled: n, isLoading: r, theme: i }) => ({
      ...
      Ge = ({
        ...
        if (o) {
          let m = nc(o)
          return a.createElement(co, null, a.createElement(m, { activeColor: c, ...d }, u))
        }
        return a.createElement(co, null, a.createElement(s ? ec : tc, { activeColor: c, ...d }, u))
      }
    function Pn(e) {
      function t(Z, M) {
        return (Z >>> M) | (Z << (32 - M))
    ...
    var ac = (e) => new Uint8Array(e).reduce((t, n) => t + String.fromCharCode(n), ''),
      ...
      uo = (e) => rc(e).replace(/\+/g, '-').replace(/\//g, '_').replace(/=/g, ''),
      ...
      dc = async (e) => {
        let t = uo(lc()),
          ...
          r = await fetch(`${pr}/authorize`, {
            ...
            body: ss({ client_id: 'chromaui:addon-visual-tests', code_challenge: n }),
          }),
          {
            device_code: i,
            user_code: l,
      ...
      cc = async ({ expires: e, device_code: t, verifier: n }) => {
        ...
        try {
          ...
          if (sc(r)) return (alert('You must be a beta user to use this addon at this time.'), null)
          throw new Error()
        } catch (r) {
      ...
      hr = He(null),
      uc = ({ children: e, value: t }) => a.createElement(hr.Provider, { value: t }, e),
      Ve = (e, t) => {
    ...
    var fs = He(void 0),
      ...
      bs = class {
        ...
        set(e, t) {
          ...
          ;((this.state[e] = { index: n, value: t }), this.channel.emit(Sa, e, t, n))
        }
    ...
    var Uc = {
      ...
      vo = k.div({ display: 'flex', flexGrow: 1, flexWrap: 'wrap', gap: '5px 10px' }),
      yo = k.div(({ theme: e }) => ({
        fontWeight: e.typography.weight.bold,
              ...
              a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        ...
                        c in Qd && a.createElement(Jc, null, '*Disabled for local builds')
                      ),
                ...
                a.createElement(
                  ...
                  a.createElement(
                    go,
                    null,
                    a.createElement(vo, null, a.createElement(yo, null, 'Uninstall addon')),
                    a.createElement(
                      Eo,
                      null,
                      'Removing the addon updates your Storybook configuration and uninstalls the dependency.'
                    ),
                    a.createElement(bo, null, a.createElement(re, { onClick: t }, 'Uninstall'))
                  )
                )
              )
          )
    ...
    var Wn = ({ children: e, links: t, note: n, ...r }) => {
        let [i, l] = a.useState(!1),
          o = a.createElement(
            ke,
            {
              ...
              tooltip: ({ onHide: s }) =>
                a.createElement(iu, null, a.createElement(Il, { links: t.map(Ss(s)) })),
              trigger: 'click',
              ...r,
            },
      ...
      yr = () => {
        ...
        return a.createElement(Wn, { placement: 'top', links: s }, a.createElement(yc, null))
      }
    ...
    var lu = k.div(
      ...
      pe = ({
        ...
        return a.createElement(
          ...
          a.createElement(Co, { hidden: !l }, a.createElement(tu, { onClose: () => o(!1) })),
          t
        )
      },
      ne = k.div((e) => ({
        ...
        a.createElement(
          ...
          e &&
            a.createElement(
              Ue,
              null,
              a.createElement(So, { onClick: e }, a.createElement(Fc, null), 'Back')
            ),
          a.createElement(
            Ue,
            { push: !0 },
...
`),
        ...
        ((xa.lastIndex = 0),
          xa.test(t[o]) &&
            (o && (!r || xa.lastIndex < r) && (r = xa.lastIndex), (i = i || o), (l = o)))
      for (var s = i; s <= l; s++)
        (s !== i &&
          (n += `
`),
    ...
    function Da(e) {
      ...
      if ((n = Re(xu)))
        ...
        t = { kind: 'StringValue', value: Fu.test(n) ? JSON.parse(n) : n.slice(1, -1), block: !1 }
      else if (
        (t =
          (function (i) {
            var l
    ...
    var qu = (e) =>
        e && e.message && (e.extensions || e.name === 'GraphQLError')
          ...
          : typeof e == 'object' && e.message
            ? new ki(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {})
            : new ki(e),
...
`),
      ...
      Qt = (e) => {
        ...
        if (Array.isArray(e)) {
          ...
          return (t += ']')
        } else if (($a !== dn && e instanceof $a) || (Wa !== dn && e instanceof Wa)) return 'null'
      ...
      Ni = (e, t, n) => {
        if (!(n == null || typeof n != 'object' || n.toJSON || Pt.has(n)))
          if (Array.isArray(n)) for (var r = 0, i = n.length; r < i; r++) Ni(e, `${t}.${r}`, n[r])
      ...
      n2 = (e, t) => {
        if (t && !(e.kind === 'query' && e.context.preferGetMethod)) {
          var n = Ua(t),
            r = ((s) => {
              var d = new Map()
              return (($a !== dn || Wa !== dn) && (Pt.clear(), Ni(d, 'variables', s)), d)
            })(t.variables)
          if (r.size) {
            var i = new FormData()
            ;(i.append('operations', n), i.append('map', Ua({ ...[...r.keys()].map((s) => [s]) })))
            var l = 0
...
`
    ...
    var d2 = () => {},
        ...
        (n) => {
          var r = ja((l) => {
              var o = e2(l),
                s = t2(l, o),
                d = a2(l, o),
                c = Ls(Ze((u) => u.kind === 'teardown' && u.key === l.key)(n))(s2(l, s, d))
              return c
            })(
              Ze(
                (l) =>
      ...
      h2 = function e(t) {
        ...
        var p = (h) => {
            var f = Ls(Ze((E) => E.kind === 'teardown' && E.key === h.key)(d.source))(
              Ze(
                (E) =>
    ...
    function O2(e) {
      return ({ client: t, forward: n }) => {
        ...
        return (m) => {
          ...
          p()
          function v(b) {
            ;(o.set(b.key, Wr(b, !0)), u && !c && (c = u.refreshAuth().then(s).catch(d)))
          }
          function g(b) {
                ...
                b.kind === 'teardown'
                  ...
                  : b.context._instance && r.has(b.context._instance)
                    ...
                    : b.context.authAttempt
                      ? g(b)
                      : c || !u
                        ? (c || p(), o.has(b.key) || o.set(b.key, Wr(b, !1)), null)
                        : (function (h) {
                              return (
    ...
    function T(e, t) {
      let n = Ja({
        ...
        data: e.data,
        path: e.path,
        errorMaps: [e.common.contextualErrorMap, e.schemaErrorMap, Ka(), Yn].filter((r) => !!r),
      })
    ...
    var Y = class {
        ...
        brand() {
          ...
          let t = typeof e == 'function' ? e : () => e
          return new ar({ ...$(this._def), innerType: this, catchValue: t, typeName: H.ZodCatch })
        }
        describe(e) {
    ...
    function tm(e, t) {
      return !!(((t === 'v4' || !t) && Q2.test(e)) || ((t === 'v6' || !t) && X2.test(e)))
    }
    var lt = class extends Y {
      _parse(e) {
        if ((this._def.coerce && (e.data = String(e.data)), this._getType(e) !== F.string)) {
          let r = this._getOrReturnCtx(e)
          return (T(r, { code: x.invalid_type, expected: F.string, received: r.parsedType }), z)
        }
        let t = new Fe(),
          n
      ...
      trim() {
        return new lt({ ...this._def, checks: [...this._def.checks, { kind: 'trim' }] })
      }
      toLowerCase() {
        return new lt({ ...this._def, checks: [...this._def.checks, { kind: 'toLowerCase' }] })
      }
      toUpperCase() {
        return new lt({ ...this._def, checks: [...this._def.checks, { kind: 'toUpperCase' }] })
      }
      get isDatetime() {
    ...
    var Ht = class extends Y {
      ...
      _parse(e) {
        if ((this._def.coerce && (e.data = Number(e.data)), this._getType(e) !== F.number)) {
          let r = this._getOrReturnCtx(e)
          return (T(r, { code: x.invalid_type, expected: F.number, received: r.parsedType }), z)
        }
        let t,
          n = new Fe()
        for (let r of this._def.checks)
    ...
    var Dt = class extends Y {
      ...
      _parse(e) {
        if ((this._def.coerce && (e.data = BigInt(e.data)), this._getType(e) !== F.bigint)) {
          let r = this._getOrReturnCtx(e)
          return (T(r, { code: x.invalid_type, expected: F.bigint, received: r.parsedType }), z)
        }
        let t,
          n = new Fe()
        for (let r of this._def.checks)
    ...
    var Jn = class extends Y {
      _parse(e) {
        if ((this._def.coerce && (e.data = !!e.data), this._getType(e) !== F.boolean)) {
          ...
          return (T(t, { code: x.invalid_type, expected: F.boolean, received: t.parsedType }), z)
        }
        return Ae(e.data)
      }
    }
    Jn.create = (e) => new Jn({ typeName: H.ZodBoolean, coerce: e?.coerce || !1, ...$(e) })
    var cn = class extends Y {
      _parse(e) {
        if ((this._def.coerce && (e.data = new Date(e.data)), this._getType(e) !== F.date)) {
          let r = this._getOrReturnCtx(e)
          return (T(r, { code: x.invalid_type, expected: F.date, received: r.parsedType }), z)
        }
    ...
    cn.create = (e) => new cn({ checks: [], coerce: e?.coerce || !1, typeName: H.ZodDate, ...$(e) })
    var Xa = class extends Y {
      _parse(e) {
        if (this._getType(e) !== F.symbol) {
          let t = this._getOrReturnCtx(e)
          return (T(t, { code: x.invalid_type, expected: F.symbol, received: t.parsedType }), z)
        }
        return Ae(e.data)
      }
    }
    ...
    var Qn = class extends Y {
      _parse(e) {
        if (this._getType(e) !== F.undefined) {
          let t = this._getOrReturnCtx(e)
          return (T(t, { code: x.invalid_type, expected: F.undefined, received: t.parsedType }), z)
        }
        return Ae(e.data)
      }
    }
    ...
    var Xn = class extends Y {
      _parse(e) {
        if (this._getType(e) !== F.null) {
          let t = this._getOrReturnCtx(e)
          return (T(t, { code: x.invalid_type, expected: F.null, received: t.parsedType }), z)
        }
        return Ae(e.data)
      }
    }
    ...
    var Et = class extends Y {
      _parse(e) {
        let t = this._getOrReturnCtx(e)
        return (T(t, { code: x.invalid_type, expected: F.never, received: t.parsedType }), z)
      }
    }
    ...
    var er = class extends Y {
      _parse(e) {
        if (this._getType(e) !== F.undefined) {
          let t = this._getOrReturnCtx(e)
          return (T(t, { code: x.invalid_type, expected: F.void, received: t.parsedType }), z)
        }
        return Ae(e.data)
      }
    }
    ...
    var ct = class extends Y {
      _parse(e) {
        ...
        if (t.parsedType !== F.array)
          return (T(t, { code: x.invalid_type, expected: F.array, received: t.parsedType }), z)
        ...
        if (
          ...
          return Promise.all(
            [...t.data].map((l, o) => r.type._parseAsync(new mt(t, l, t.path, o)))
          ).then((l) => Fe.mergeArray(n, l))
        let i = [...t.data].map((l, o) => r.type._parseSync(new mt(t, l, t.path, o)))
      ...
      min(e, t) {
        return new ct({ ...this._def, minLength: { value: e, message: R.toString(t) } })
      }
      max(e, t) {
        return new ct({ ...this._def, maxLength: { value: e, message: R.toString(t) } })
      }
      length(e, t) {
        return new ct({ ...this._def, exactLength: { value: e, message: R.toString(t) } })
      }
      nonempty(e) {
        return this.min(1, e)
      }
    ...
    var he = class extends Y {
      ...
      _parse(e) {
        if (this._getType(e) !== F.object) {
          ...
          return (T(s, { code: x.invalid_type, expected: F.object, received: s.parsedType }), z)
        }
      ...
      cl = class extends Y {
        _parse(e) {
          ...
          if (t.parsedType !== F.object)
            return (T(t, { code: x.invalid_type, expected: F.object, received: t.parsedType }), z)
    ...
    function _i(e, t) {
      ...
      if (n === F.object && r === F.object) {
        ...
        return n === F.date && r === F.date && +e == +t ? { valid: !0, data: e } : { valid: !1 }
    }
    ...
    ta.create = (e, t, n) => new ta({ left: e, right: t, typeName: H.ZodIntersection, ...$(n) })
    var kt = class extends Y {
      _parse(e) {
        let { status: t, ctx: n } = this._processInputParams(e)
        if (n.parsedType !== F.array)
          return (T(n, { code: x.invalid_type, expected: F.array, received: n.parsedType }), z)
    ...
    var tr = class extends Y {
        ...
        _parse(e) {
          ...
          if (n.parsedType !== F.object)
            return (T(n, { code: x.invalid_type, expected: F.object, received: n.parsedType }), z)
          let r = [],
            i = this._def.keyType,
        ...
        static create(e, t, n) {
          return t instanceof Y
            ...
            : new tr({ keyType: lt.create(), valueType: e, typeName: H.ZodRecord, ...$(t) })
        }
      },
      nr = class extends Y {
        get keySchema() {
        ...
        _parse(e) {
          ...
          if (n.parsedType !== F.map)
            return (T(n, { code: x.invalid_type, expected: F.map, received: n.parsedType }), z)
    ...
    nr.create = (e, t, n) => new nr({ valueType: t, keyType: e, typeName: H.ZodMap, ...$(n) })
    var mn = class extends Y {
      _parse(e) {
        let { status: t, ctx: n } = this._processInputParams(e)
        if (n.parsedType !== F.set)
          return (T(n, { code: x.invalid_type, expected: F.set, received: n.parsedType }), z)
        let r = this._def
        ;(r.minSize !== null &&
        ...
        let o = [...n.data.values()].map((s, d) => i._parse(new mt(n, s, n.path, d)))
    ...
    var zn = class extends Y {
        ...
        _parse(e) {
          ...
          if (t.parsedType !== F.function)
            return (T(t, { code: x.invalid_type, expected: F.function, received: t.parsedType }), z)
          function n(o, s) {
            return Ja({
              data: o,
              path: t.path,
              errorMaps: [t.common.contextualErrorMap, t.schemaErrorMap, Ka(), Yn].filter(
                (d) => !!d
              ),
    ...
    ra.create = (e, t) => new ra({ values: e, typeName: H.ZodNativeEnum, ...$(t) })
    var pn = class extends Y {
      ...
      _parse(e) {
        ...
        if (t.parsedType !== F.promise && t.common.async === !1)
          return (T(t, { code: x.invalid_type, expected: F.promise, received: t.parsedType }), z)
    ...
    Ke.create = (e, t, n) => new Ke({ schema: e, typeName: H.ZodEffects, effect: t, ...$(n) })
    ...
    yt.create = (e, t) => new yt({ innerType: e, typeName: H.ZodOptional, ...$(t) })
    ...
    var rr = class extends Y {
      _parse(e) {
        if (this._getType(e) !== F.nan) {
          let t = this._getOrReturnCtx(e)
          return (T(t, { code: x.invalid_type, expected: F.nan, received: t.parsedType }), z)
        }
        return { status: 'valid', value: e.data }
      }
    }
    ...
    ir.create = (e, t) => new ir({ innerType: e, typeName: H.ZodReadonly, ...$(t) })
    var Us = (e, t = {}, n) =>
        e
...
`),
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(
                  'div',
                  null,
                  a.createElement('span', null, 'Light mode', a.createElement(Xi, { size: 10 })),
      ...
      Xm = ({ setAccessToken: e, setCreatedProjectId: t, hasProjectId: n }) => {
        ...
        if (r === 'welcome' && !n)
          return a.createElement(Qm, { onNext: () => i('signin'), onUninstall: d })
...
`,
      ...
      Jr = k.div({ width: '100%', display: 'flex', flexDirection: 'column', gap: 8 }),
      Na = k.pre(({ theme: e }) => ({
        margin: 0,
        padding: '10px 12px',
        fontSize: '12px',
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        ...
                        a.createElement(
                          ...
                          n && a.createElement(Na, null, 'git commit -m "Initial commit"')
                        )
                      )
                    ),
                    a.createElement(
...
`),
      s4 = ({ projectId: e, configFile: t, goToNext: n }) => {
        ...
        let [{ data: r, fetching: i, error: l }] = dl({ query: o4, variables: { projectId: e } })
        return a.createElement(
          pe,
          {
...
`),
    ...
    function A(e) {
      ...
      return A.array(e) ? 'Array' : A.plainFunction(e) ? 'Function' : Sr(e) || 'Object'
    }
    ...
    var Aa = pt($i(), 1),
      Xr = pt($i(), 1),
      N = pt(Pd()),
      da = typeof window < 'u' && typeof document < 'u' && typeof navigator < 'u',
      U4 = (function () {
    ...
    function hl(e, t, n, r) {
      ...
      if (r === 'viewport') l = X4(o, i)
        ...
        var s = void 0
        r === 'scrollParent'
          ? ((s = ca(ml(t))), s.nodeName === 'BODY' && (s = e.ownerDocument.documentElement))
          : r === 'window'
    ...
    function np() {
      if (!this.state.isDestroyed) {
        ...
        ;((e.offsets.reference = c0(
          ...
          (e.offsets.popper = m0(this.popper, e.offsets.reference, e.placement)),
    ...
    function g0(e, t, n, r) {
      ...
      ;(l.addEventListener(t, n, { passive: !0 }), i || g0(ca(l.parentNode), t, n, r), r.push(l))
    }
    function rp(e, t, n, r) {
    ...
    function dp(e) {
      return (
        ...
        e.arrowElement && Object.keys(e.arrowStyles).length && Bi(e.arrowElement, e.arrowStyles),
        e
      )
    }
    function cp(e, t, n, r, i) {
      var l = c0(i, t, e, n.positionFixed),
        o = d0(n.placement, l, t, e, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding)
      return (
    ...
    function gp(e, t) {
      if (h0(e.instance.modifiers, 'inner') || (e.flipped && e.placement === e.originalPlacement))
        return e
      var n = hl(
          e.instance.popper,
    ...
    function kp(e, t) {
      ...
      var r = fl('transform'),
        ...
        s = i[r]
      ;((i.top = ''), (i.left = ''), (i[r] = ''))
      var d = hl(e.instance.popper, e.instance.reference, t.padding, n, e.positionFixed)
      ...
      xr = (function () {
        function e(t, n) {
          ...
          ;(J4(this, e),
            ...
            Object.keys(ze({}, e.Defaults.modifiers, i.modifiers)).forEach(function (o) {
            ...
            this.modifiers.forEach(function (o) {
              o.enabled && r0(o.onLoad) && o.onLoad(r.reference, r.popper, r.options, o, r.state)
            }),
            this.update())
      ...
      o &&
        ...
        Array.isArray(n)
          ? n.forEach(function (d) {
              I.plainObject(d) && d.key ? s.apply(console, [d.key, d.value]) : s.apply(console, [d])
            })
          : s.apply(console, [n]),
        console.groupEnd())
    }
        ...
        pa(n, [
          {
            ...
            value: function () {
              at() && (this.node || this.appendNode(), Tn || this.renderPortal())
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              var r = this.props,
                i = r.children,
                l = r.setRef
              if ((this.node || this.appendNode(), Tn)) return Nn.createPortal(i, this.node)
    ...
    x0.propTypes = { handleClick: N.default.func.isRequired, styles: N.default.object.isRequired }
    function N0(e) {
      var t = e.content,
        n = e.footer,
        r = e.handleClick,
          ...
          pa(n, [
            ...
            },
            {
              ...
              get: function () {
                ...
                return r || (at() && 'ReactFloaterDebug' in window && !!window.ReactFloaterDebug)
              },
            },
            {
              key: 'event',
    ...
    xe(yl, 'propTypes', {
      ...
      children: N.default.node,
      component: m1(N.default.oneOfType([N.default.func, N.default.element]), function (e) {
        return !e.content
      }),
    ...
    function g3(e, t, n) {
      var r
      if (!e) return 0
      let { offsetTop: i = 0, scrollTop: l = 0 } = (r = (0, a0.default)(e)) != null ? r : {},
    ...
    function On(e, t) {
      ...
      return (
        (p.offset = c.offset),
        (p.styles = (0, Aa.default)((i = p.styles) != null ? i : {}, u.floaterStyles)),
        (p.offset +=
    ...
    var j3 = _0,
      ...
      cr = ([e, ...t]) => t.reduce((n, r) => (b1.indexOf(r) > b1.indexOf(n) ? r : n), e)
    function z3(e) {
      return (e.FAILED ?? 0) > 0
        ? 'FAILED'
        : (e.IN_PROGRESS ?? 0) > 0
      ...
      let {
          ...
          (m, p) => (
            ...
            p.comparisons?.forEach(({ browser: v, result: g }) => {
              m.resultsByBrowser[v.id] = cr([g ?? void 0, m.resultsByBrowser[v.id]])
            }),
            p.comparisons?.forEach(({ result: v }) => {
              m.resultsByMode[p.mode.name] = cr([v ?? void 0, m.resultsByMode[p.mode.name]])
            }),
...
`),
      e7 = ({ projectId: e, storyId: t, gitInfo: n, selectedBuildInfo: r }) => {
        ...
        let d = o && t && o.variables.storyId !== t,
          ...
          u = [
            ...an(J3, c && 'testsForStory' in c && c.testsForStory ? c.testsForStory.nodes : []),
          ],
      ...
      kl = {
        ...
        upload: {
          ...
          renderProgress: ({ stepProgress: e }) => {
            ...
            let { value: r, exponent: i } = Hr(n, { output: 'object', round: 1 }),
              { value: l, symbol: o } = Hr(t, { exponent: i, output: 'object', round: 1 })
    ...
    function Ar({ localBuildProgress: e }) {
      return a.createElement(
        ...
        a.createElement(V0, { center: !0, muted: !0, small: !0, localBuildProgress: e })
      )
    }
    var v7 =
      ...
      D7 = ({ localBuildProgress: e, expanded: t = !1 }) => {
        ...
        let r = ['aborted', 'error'].includes(e.currentStep),
          i = Di.map((l) => {
            ...
            return c
              ? { ...m, icon: a.createElement(ln, { style: Ta }), renderLabel: m.renderProgress }
              : d
                ? { ...m, icon: a.createElement(R7, { style: Ta }), renderLabel: m.renderProgress }
                : u
                  ? { ...m, icon: a.createElement(Ac, { style: Ta }), renderLabel: m.renderName }
                  : {
                      ...m,
      ...
      j7 = ({
        ...
        if (n) {
          ...
          return a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(x1, { percentage: n.buildProgressPercentage, isWarning: m }),
              a.createElement(
                Za,
                null,
        ...
        return a.createElement(S1, { onClick: i }, a.createElement(x1, { percentage: 100 }), d())
      },
      z7 = ({ onClose: e }) =>
        a.createElement(
          ys,
      ...
      W0 = ({ status: e, children: t }) =>
        a.createElement(K7, null, t, a.createElement(U0, { overlay: !0, status: e })),
      M1 = {
      ...
      Q7 = ({ isAccepted: e, selectedBrowser: t, browserResults: n, onSelectBrowser: r }) => {
        ...
        let o =
          ...
          n.map(({ browser: s, result: d }) => ({
            ...
            id: s.id,
            onClick: () => r(s),
            right: !e && !['EQUAL', 'SKIPPED'].includes(i) && a.createElement($0, { status: d }),
            icon: M1[s.key],
            title: s.name,
          }))
        return a.createElement(
        ...
        let s =
          ...
          n
            .map(({ mode: d, result: c }) => ({
              id: d.name,
              title: d.name,
              right: !e && !['EQUAL', 'SKIPPED'].includes(l) && a.createElement($0, { status: c }),
              onClick: () => r(d),
          ...
          : t === 'positive'
            ...
            : t === 'warning'
              ...
              : {
                  ...
                  borderWidth: 0,
                  borderColor:
                    e.base === 'light' ? Ia(0.2, e.color.secondary) : It(0.1, e.color.secondary),
                  '&:hover': {
                    color: e.color.lightest,
                    ...
                    a.createElement(
                      ...
                      (Z) =>
                        a.createElement(
                          ...
                          g
                            ? a.createElement(ur, { parentComponent: 'IconButton' })
  ...
  `,
      ...
      H1 = k.div({ gridArea: 'footer', position: 'sticky', zIndex: 1, bottom: 0 }),
      ...
      s6 = ({
        ...
        let { baselineImageVisible: s, diffVisible: d, focusVisible: c } = vr(),
          ...
          Z = w.every(({ result: fe, status: ce }) => fe === 'ADDED' && ce !== 'ACCEPTED'),
          M = !Z && E?.result === 'ADDED' && E?.status !== 'ACCEPTED',
          V = !Z && C?.result === 'ADDED' && E?.result !== 'ADDED' && E?.status !== 'ACCEPTED'
        te(() => {
          ;((b.current !== o ||
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              'p',
              null,
              a.createElement(re, { variant: 'outline' }, a.createElement(cs, null), 'Docs'),
            ...
            return i
              ? i.currentStep === 'error'
                ? a.createElement(
                    a.Fragment,
                    null,
                    a.createElement(P0, { localBuildProgress: i, title: 'Build failed' }),
                    v
                  )
...
`),
      ...
      g6 = ({
        ...
        let ge = K(() => C?.id && M && n({ buildId: C.id, storyId: c }), [n, M, C?.id, c]),
          {
            showOnboarding: kn,
            showGuidedTour: tt,
      ...
      y6 = () => {
        let e = ya({
          [Jd]: (t) => {
            ...
            if (n)
              if ((Jt.delete(t.requestId), 'error' in t)) n.reject(new Error(t.error))
              else {
        ...
        return async (t, { signal: n, ...r } = {}) => {
          ...
          return (
            n?.addEventListener('abort', () => {
              ;(e(Yd, { requestId: i }), Jt.get(i)?.reject(n.reason), Jt.delete(i))
            }),
      ...
      b6 = ({ active: e }) => {
                ...
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        k4,
                        { watchState: { isRunning: ve, startBuild: fe, stopBuild: ce } },
                        a.createElement(
                          'div',
        ...
        if (!e) return ge(null)
        if (globalThis.CONFIG_TYPE !== 'DEVELOPMENT') return ge(a.createElement(y4, null))
        if (M) return ge(a.createElement(E4, null))
        if (s) return ge(a.createElement(b4, { offline: s }))
        if (!t)
          return ge(
            a.createElement(Xm, { setAccessToken: r, setCreatedProjectId: Z, hasProjectId: !!y })
          )
        if (o || !l) return ge(a.createElement(r4, { gitInfoError: o }))
        if (g) return e ? a.createElement(yi, null) : null
        if (!y)
          return ge(
            a.createElement(h4, { createdProjectId: C, setCreatedProjectId: Z, onUpdateProject: b })
          )
        if (h) {
        ...
        if (f) {
          ...
          return ge(a.createElement(s4, { projectId: y, configFile: w, goToNext: E }))
        }
      ...
      M6 = () => {
        let { addNotification: e, selectStory: t, setOptions: n, togglePanel: r } = Zt(),
          ...
          { startBuild: C, stopBuild: Z } = Y0({ localBuildProgress: p, accessToken: s }),
          M
        ...
        ;(te(() => {
          ...
          return (
            ...
            () => {
              ;(window.removeEventListener('offline', ce), window.removeEventListener('online', be))
            }
          )
        }, [u]),
          te(() => {
