/*! For license information please see 8735.354bfa57.iframe.bundle.js.LICENSE.txt */
'use strict'
    ...
    './node_modules/next/dist/compiled/react-dom/cjs/react-dom-client.production.js': (
                      ...
                      if ((key = newChild.type) === REACT_FRAGMENT_TYPE) {
                        if (7 === currentFirstChild.tag) {
                          ;(deleteRemainingChildren(returnFiber, currentFirstChild.sibling),
                            ((lanes = useFiber(currentFirstChild, newChild.props.children)).return =
                              returnFiber),
                            (returnFiber = lanes))
                          break a
                        }
          ...
          switch (provider.tag) {
            ...
            case 3:
              var lane = requestUpdateLane(),
                root$69 = enqueueUpdate(provider, (fiber = createUpdate(lane)), lane)
              return (
                null !== root$69 &&
        ...
        if (
          ...
          if (128 & workInProgress.flags) {
            if (
              ...
              for (
                nextChildren = workInProgress.child = current.child, prevState = 0;
                null !== nextChildren;
      ...
      function completeWork(current, workInProgress, renderLanes) {
        ...
        switch ((popTreeContext(workInProgress), workInProgress.tag)) {
              ...
              null === current
                ? (markUpdate(workInProgress),
                  null !== nextResource
                    ...
                    : (bubbleProperties(workInProgress),
                      preloadInstanceAndSuspendIfNeeded(workInProgress, type, 0, 0, renderLanes)))
                : nextResource
          ...
          case 19:
            if ((pop(suspenseStackCursor), null === (newProps = workInProgress.memoizedState)))
              return (bubbleProperties(workInProgress), null)
            if (
            ...
            return null !== newProps.tail
              ? ((current = newProps.tail),
                ...
                push(suspenseStackCursor, type ? (1 & renderLanes) | 2 : 1 & renderLanes),
                isHydrating && pushTreeFork(workInProgress, newProps.treeForkCount),
                current)
        ...
        try {
          ...
          ;(!(function updateProperties(domElement, tag, lastProps, nextProps) {
            switch (tag) {
              ...
              case 'input':
                ...
                for (var propKey$200 in nextProps) {
                  ...
                  if (
                    ...
                    nextProps.hasOwnProperty(propKey$200) && (null != propKey || null != lastProp))
                  )
                    switch (propKey$200) {
                      case 'type':
                        type = propKey
                      ...
                      default:
                        propKey !== lastProp &&
                          setProp(domElement, tag, propKey$200, propKey, nextProps, lastProp)
                    }
                }
              ...
              case 'select':
                for (type in ((propKey = value = defaultValue = propKey$200 = null), lastProps))
                  if (
              ...
              case 'textarea':
                for (defaultValue in ((propKey = propKey$200 = null), lastProps))
                  if (
              ...
              case 'option':
                for (var propKey$216 in lastProps)
                  if (
                    ...
                    else setProp(domElement, tag, propKey$216, null, nextProps, propKey$200)
                for (lastDefaultValue in nextProps)
                  if (
                    ...
                    else setProp(domElement, tag, lastDefaultValue, propKey$200, nextProps, propKey)
                return
              case 'img':
              case 'link':
              case 'area':
                ...
                for (checked in nextProps)
                  if (
                    ...
                    switch (checked) {
                      case 'children':
                      case 'dangerouslySetInnerHTML':
                        if (null != propKey$200) throw Error(formatProdErrorMessage(137, tag))
                        break
                      default:
                        setProp(domElement, tag, checked, propKey$200, nextProps, propKey)
                    }
                return
              default:
      ...
      function recursivelyTraverseReconnectPassiveEffects(
        ...
        for (
          includeWorkInProgressEffects =
            includeWorkInProgressEffects && !!(10256 & parentFiber.subtreeFlags),
            parentFiber = parentFiber.child;
          null !== parentFiber;
                      ...
                      switch (
                        ...
                        case 3:
                          if (1024 & root)
                            if (
                              9 ===
                              (JSCompiler_temp = (root = firstChild.stateNode.containerInfo)
                                .nodeType)
                            )
      ...
      function flushSyncWorkAcrossRoots_impl(syncTransitionLanes, onlyLegacy) {
        if (!isFlushingWork && mightHavePendingSyncWork) {
          isFlushingWork = !0
          do {
            for (var didPerformSomeWork = !1, root$169 = firstScheduledRoot; null !== root$169; ) {
              if (!onlyLegacy)
                  ...
                  ((JSCompiler_inline_result = workInProgressRootRenderLanes),
                    !(
                      ...
                      (JSCompiler_inline_result = getNextLanes(
                        ...
                        null !== root$169.cancelPendingCommit || -1 !== root$169.timeoutHandle
                      ))
                    ) ||
      ...
      function requestTransitionLane() {
        if (0 === currentEventTransitionLane) {
          currentEventTransitionLane =
            0 !== currentEntangledLane ? currentEntangledLane : claimNextTransitionLane()
        }
      ...
      for (
        ...
        var eventName$jscomp$inline_1574 = simpleEventPluginEvents[i$jscomp$inline_1573]
        registerSimpleEvent(
          eventName$jscomp$inline_1574.toLowerCase(),
          'on' +
            (eventName$jscomp$inline_1574[0].toUpperCase() + eventName$jscomp$inline_1574.slice(1))
        )
      }
              ...
              if (props.hasOwnProperty(hasSrc)) {
                ...
                if (null != propValue$183)
                  switch (hasSrc) {
                    ...
                    case 'children':
                    case 'dangerouslySetInnerHTML':
                      if (null != propValue$183) throw Error(formatProdErrorMessage(137, tag))
                      break
                    default:
            ...
            if (isCustomElement(tag)) {
              for (propValue$183 in props)
                props.hasOwnProperty(propValue$183) &&
                  ...
                  setPropOnCustomElement(domElement, tag, propValue$183, hasSrc, props, void 0)
              return
            }
        }
              ...
              if (
                (resource$243 ||
                  ...
                  (styles$242 = JSCompiler_inline_result.querySelector(
                    ...
                    !styles$242._p &&
                    ((resource$243.instance = styles$242), (resource$243.state.loading = 5)),
                  preloadPropsMap.has(type) ||
                    ...
                    styles$242 ||
                      ...
                      })(JSCompiler_inline_result, type, pendingProps, resource$243.state))),
          ...
          switch (resource.type) {
            ...
            case 'stylesheet':
              ...
              ;((instance = stylesheetPropsFromRawProps(props)),
                ...
                markNodeAsHoistable(
                  (instance$248 = (hoistableRoot.ownerDocument || hoistableRoot).createElement(
                    'link'
                  ))
                ))
            ...
            case 'script':
              return (
                ...
                (styleProps = hoistableRoot.querySelector(getScriptSelectorFromKey(instance$248)))
      ...
      if ('19.2.0-canary-0bdb9206-20250818' !== isomorphicReactPackageVersion$jscomp$inline_1833)
        throw Error(
          formatProdErrorMessage(
            527,
      ...
      if ('undefined' != typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
        ...
        if (!hook$jscomp$inline_2337.isDisabled && hook$jscomp$inline_2337.supportsFiber)
          try {
            ;((rendererID = hook$jscomp$inline_2337.inject(internals$jscomp$inline_2336)),
