    ...
    './components/AnimatedLogo.tsx': (
      ...
      function AnimatedLogo({
        ...
        const [frame, setFrame] = (0, react__WEBPACK_IMPORTED_MODULE_3__.useState)(0),
          ...
          asciiLogo = (0, react__WEBPACK_IMPORTED_MODULE_3__.useMemo)(
            () => ['█▄ █ █▀▀ █ █ █ ▀█▀ █ █', '█ ▀█ █▀▀ ▀▄▀▄▀  █  █▀█', '█  █ █▄▄  ▀ ▀   █  █ █'],
            []
          ),
          asciiDotAI = (0, react__WEBPACK_IMPORTED_MODULE_3__.useMemo)(
            () => ['  ▄▀█ █', '  █▀█ █', '°'],
            []
          ),
          blockChars = ['█', '▓', '▒', '░', '▄', '▀', '▌', '▐', '■', '□', '▪', '▫'],
                  ...
                  children: (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)('div', {
                    ...
                    children: asciiLogo.map((line, lineIndex) => {
                      ...
                      return (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                        _barrel_optimize_names_motion_framer_motion__WEBPACK_IMPORTED_MODULE_2__.P
                          .div,
                        {
