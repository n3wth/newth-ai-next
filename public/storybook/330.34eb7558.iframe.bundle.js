  ...
  [330],
  {
    './node_modules/framer-motion/dist/es/components/AnimatePresence/use-presence.mjs': (
      ...
      var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        ...
        _context_PresenceContext_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      function usePresence(subscribe = !0) {
        ...
        const safeToRemove = (0, react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(
    ...
    './node_modules/framer-motion/dist/es/context/LayoutGroupContext.mjs': (
      ...
      __webpack_require__.d(__webpack_exports__, { L: () => LayoutGroupContext })
    ...
    './node_modules/framer-motion/dist/es/context/MotionConfigContext.mjs': (
      ...
      __webpack_require__.d(__webpack_exports__, { Q: () => MotionConfigContext })
    ...
    './node_modules/framer-motion/dist/es/render/components/motion/proxy.mjs': (
      ...
      const transformPropOrder = [
        ...
        rebaseAngle = (angle) => ((angle %= 360) < 0 && (angle += 360), angle),
      ...
      function parseValueFromTransform(transform, name) {
        if (!transform || 'none' === transform) return defaultTransformValue(name)
        const matrix3dMatch = transform.match(/^matrix3d\(([-\d.e\s,]+)\)$/u)
        let parsers, match
        if (matrix3dMatch) ((parsers = matrix3dParsers), (match = matrix3dMatch))
        else {
        ...
        return 'function' == typeof valueParser ? valueParser(values) : values[valueParser]
      }
      ...
      const positionalKeys = new Set([
        ...
        number = { test: (v) => 'number' == typeof v, parse: parseFloat, transform: (v) => v },
        alpha = { ...number, transform: (v) => clamp(0, 1, v) },
        scale = { ...number, default: 1 },
        createUnitType = (unit) => ({
          test: (v) => 'string' == typeof v && v.endsWith(unit) && 1 === v.split(' ').length,
          parse: parseFloat,
          transform: (v) => `${v}${unit}`,
        }),
          ...
          steps = stepsOrder.reduce(
            (acc, key) => (
              (acc[key] = (function createRenderStep(runNextFrame, stepName) {
                ...
                let latestFrameData = { delta: 0, timestamp: 0, isProcessing: !1 },
                  numCalls = 0
                    ...
                    ;((latestFrameData = frameData),
                      isProcessing
                        ...
                        : ((isProcessing = !0),
                          ...
                          thisFrame.clear(),
                          (isProcessing = !1),
                          flushNextFrame && ((flushNextFrame = !1), step.process(frameData))))
                  },
                }
                return step
      ...
      const {
          ...
          'undefined' != typeof requestAnimationFrame ? requestAnimationFrame : noop,
          !0
        ),
        toResolve = new Set()
      let isScheduled = !1,
      ...
      function measureAllKeyframes() {
        if (anyNeedsMeasurement) {
          ...
          ;(elementsToMeasure.forEach((element) => {
            const removedTransforms = (function removeNonTranslationalTransform(visualElement) {
      ...
      class KeyframeResolver {
        ...
        cancel() {
          'scheduled' === this.state && (toResolve.delete(this), (this.state = 'pending'))
        }
        resume() {
      ...
      function isNone(value) {
        return 'number' == typeof value
          ? 0 === value
          : null === value || 'none' === value || '0' === value || isZeroValueString(value)
      }
      ...
      const singleColorRegex =
        ...
        isColorString = (type, testProp) => (v) =>
          Boolean(
            ('string' == typeof v && singleColorRegex.test(v) && v.startsWith(type)) ||
              (testProp &&
        ...
        rgbUnit = { ...number, transform: (v) => Math.round(((v) => clamp(0, 255, v))(v)) },
        rgba = {
            ...
            (parsedValue) => (
              color.test(parsedValue)
                ...
                : parsedValue.startsWith('var(')
                  ? (indexes.var.push(i), types.push('var'), values.push(parsedValue))
        ...
        return (v) => {
          ...
          for (let i = 0; i < numSections; i++)
            if (((output += split[i]), void 0 !== v[i])) {
              const type = types[i]
              output +=
                'number' === type ? sanitize(v[i]) : 'color' === type ? color.transform(v[i]) : v[i]
            }
          return output
        }
      }
      const convertNumbersToZero = (v) =>
        'number' == typeof v ? 0 : color.test(v) ? color.getAnimatableNone(v) : v
      const complex = {
      ...
      class DOMKeyframesResolver extends KeyframeResolver {
          ...
          if (originType !== targetType)
            if (isNumOrPxType(originType) && isNumOrPxType(targetType))
              for (let i = 0; i < unresolvedKeyframes.length; i++) {
                ...
                'string' == typeof value && (unresolvedKeyframes[i] = parseFloat(value))
              }
        ...
        resolveNoneKeyframes() {
          const { unresolvedKeyframes, name } = this,
            noneKeyframeIndexes = []
          for (let i = 0; i < unresolvedKeyframes.length; i++)
            (null === unresolvedKeyframes[i] || isNone(unresolvedKeyframes[i])) &&
      ...
      class MotionValue {
        ...
        addDependent(dependent) {
          ;(this.dependents || (this.dependents = new Set()), this.dependents.add(dependent))
        }
      ...
      const valueTypes = [...dimensionValueTypes, color, complex],
        { schedule: microtask, cancel: cancelMicrotask } = createRenderBatcher(queueMicrotask, !1),
        featureProps = {
          animation: [
            'animate',
            'variants',
      ...
      const createBox = () => ({ x: { min: 0, max: 0 }, y: { min: 0, max: 0 } })
      ...
      class VisualElement {
        ...
        constructor(
          ...
          ;((this.current = null),
            ...
            (this.scheduleRender = () => {
              ...
              this.renderScheduledAt < now &&
                ((this.renderScheduledAt = now), frame_frame.render(this.render, !1, !0))
            }))
          ...
          for (const key in initialMotionValues) {
            ...
            void 0 !== latestValues[key] && isMotionValue(value) && value.set(latestValues[key])
          }
        }
        mount(instance) {
          ;((this.current = instance),
            ...
            (this.shouldReduceMotion =
              ...
              ('always' === this.reducedMotionConfig || prefersReducedMotion.current)),
        ...
        update(props, presenceContext) {
          ...
          ;((this.prevMotionValues = (function updateMotionValuesFromProps(element, next, prev) {
        ...
        readValue(key, target) {
          ...
          return (
            null != value &&
              ('string' == typeof value && (isNumericalString(value) || isZeroValueString(value))
      ...
      function renderHTML(element, { style, vars }, styleProp, projection) {
        ...
        for (key in (projection?.applyProjectionStyles(elementStyle, styleProp), vars))
      ...
      function isForcedMotionValue(key, { layout, layoutId }) {
        return (
          ...
          key.startsWith('origin') ||
          ((layout || void 0 !== layoutId) && (!!scaleCorrectors[key] || 'opacity' === key))
        )
      }
      ...
      function buildSVGAttrs(
        ...
        if ((buildHTMLStyles(state, latest, transformTemplate), isSVGTag))
          return void (state.style.viewBox && (state.attrs.viewBox = state.style.viewBox))
        ;((state.attrs = state.style), (state.style = {}))
        const { attrs, style } = state
        ;(attrs.transform && ((style.transform = attrs.transform), delete attrs.transform),
      ...
      function isSVGComponent(Component) {
        return (
          ...
          !Component.includes('-') &&
          !!(lowercaseSVGElements.indexOf(Component) > -1 || /[A-Z]/u.test(Component))
        )
      }
      const createDomVisualElement = (Component, options) =>
        isSVGComponent(Component)
          ? new SVGVisualElement(options)
          : new HTMLVisualElement(options, { allowProjection: Component !== react.Fragment })
        ...
        return (
          ...
          Object.assign(
            ...
            (function useInitialMotionValues({ transformTemplate }, visualState) {
              return (0, react.useMemo)(() => {
                const state = { style: {}, transform: {}, transformOrigin: {}, vars: {} }
                return (
      ...
      function useSVGProps(props, visualState, _isStatic, Component) {
        const visualProps = (0, react.useMemo)(() => {
          const state = { style: {}, transform: {}, transformOrigin: {}, vars: {}, attrs: {} }
          return (
            buildSVGAttrs(
              state,
              visualState,
        ...
        !(function loadExternalIsValidProp(isValidProp) {
          ...
          Object(
            (function webpackMissingModule() {
              var e = new Error("Cannot find module '@emotion/is-prop-valid'")
      ...
      function useRender(
        ...
        return (0, react.createElement)(Component, { ...elementProps, children: renderedChildren })
      }
      ...
      function makeLatestValues(props, context, presenceContext, scrapeMotionValues) {
        ...
        let isInitialAnimationBlocked = !!presenceContext && !1 === presenceContext.initial
            ...
            if (resolved) {
              ...
              for (const key in target) {
                ...
                if (Array.isArray(valueTarget)) {
                  valueTarget = valueTarget[isInitialAnimationBlocked ? valueTarget.length - 1 : 0]
                }
      ...
      function useVisualElement(
        ...
        const { visualElement: parent } = (0, react.useContext)(MotionContext),
          ...
          presenceContext = (0, react.useContext)(PresenceContext.t),
          reducedMotionConfig = (0, react.useContext)(MotionConfigContext.Q).reducedMotion,
        ...
        ;((createVisualElement = createVisualElement || lazyContext.renderer),
          !visualElementRef.current &&
            ...
            (visualElementRef.current = createVisualElement(Component, {
              ...
              props,
              presenceContext,
              blockInitialAnimation: !!presenceContext && !1 === presenceContext.initial,
              reducedMotionConfig,
            })))
        const visualElement = visualElementRef.current,
          initialLayoutGroupConfig = (0, react.useContext)(SwitchLayoutGroupContext)
        !visualElement ||
          ...
          })(visualElementRef.current, props, ProjectionNodeConstructor, initialLayoutGroupConfig)
      ...
      function createMotionComponent(
        ...
        function MotionDOMComponent(props, externalRef) {
          ...
          if (!isStatic && is_browser.B) {
            ...
            const layoutProjection = (function getProjectionFunctionality(props) {
      ...
      function createMotionProxy(preloadedFeatures, createVisualElement) {
        ...
        const componentCache = new Map(),
          factory = (Component, options) =>
            createMotionComponent(Component, options, preloadedFeatures, createVisualElement)
        return new Proxy((Component, options) => factory(Component, options), {
          get: (_target, key) =>
            'create' === key
              ? factory
      ...
      function mix(from, to, p) {
        if ('number' == typeof from && 'number' == typeof to && 'number' == typeof p)
      ...
      const frameloopDriver = (update) => {
          ...
          return {
            start: (keepAlive = !0) => frame_frame.update(passTimestamp, keepAlive),
        ...
        generateLinearEasing = (easing, duration, resolution = 10) => {
          ...
          for (let i = 0; i < numPoints; i++)
            points += Math.round(1e4 * easing(i / (numPoints - 1))) / 1e4 + ', '
        ...
        ;((dampingRatio = clamp(
          ...
          dampingRatio < 1
            ? ((envelope = (undampedFreq) => {
                ...
                return (
                  0.001 -
                  ((exponentialDecay - velocity) / calcAngularFreq(undampedFreq, dampingRatio)) *
                    Math.exp(-delta)
                )
              }),
              (derivative = (undampedFreq) => {
                ...
                return ((0.001 - envelope(undampedFreq) > 0 ? -1 : 1) * ((d - e) * f)) / g
              }))
            : ((envelope = (undampedFreq) =>
                Math.exp(-undampedFreq * duration) * ((undampedFreq - velocity) * duration + 1) -
                0.001),
              (derivative = (undampedFreq) =>
                Math.exp(-undampedFreq * duration) *
                (duration * duration * (velocity - undampedFreq)))))
        const undampedFreq = (function approximateRoot(envelope, derivative, initialGuess) {
          let result = initialGuess
          for (let i = 1; i < rootIterations; i++) result -= envelope(result) / derivative(result)
          return result
        })(envelope, derivative, 5 / duration)
        if (((duration = time_conversion_secondsToMilliseconds(duration)), isNaN(undampedFreq)))
          return { stiffness: springDefaults_stiffness, damping: springDefaults_damping, duration }
        {
          const stiffness = Math.pow(undampedFreq, 2) * mass
          return { stiffness, damping: 2 * dampingRatio * Math.sqrt(mass * stiffness), duration }
        }
      }
      ...
      function spring(
        ...
        const options =
          'object' != typeof optionsOrVisualDuration
            ? { visualDuration: optionsOrVisualDuration, keyframes: [0, 1], bounce }
            ...
            (function getSpringOptions(options) {
              ...
              if (!isSpringType(options, physicsKeys) && isSpringType(options, durationKeys))
                if (options.visualDuration) {
                  ...
                  ;((springOptions = { ...springOptions, ...derived, mass: springDefaults_mass }),
                    (springOptions.isResolvedFromDuration = !0))
                }
              return springOptions
            })({ ...options, velocity: -millisecondsToSeconds(options.velocity || 0) }),
      ...
      function inertia({
        ...
        const checkCatchBoundary = (t) => {
          var v
          ;((v = state.value), (void 0 !== min && v < min) || (void 0 !== max && v > max)) &&
      ...
      const easeIn = cubicBezier(0.42, 0, 1, 1),
        ...
        isBezierDefinition = (easing) => Array.isArray(easing) && 'number' == typeof easing[0],
        easingLookup = {
          linear: noop,
          easeIn,
          easeInOut,
        ...
        easingDefinitionToFunction = (definition) => {
          ...
          return 'string' == typeof definition ? easingLookup[definition] : definition
        },
      ...
      function interpolate(input, output, { clamp: isClamp = !0, ease, mixer } = {}) {
        ...
        if (2 === inputLength && output[0] === output[1]) return () => output[1]
      ...
      function keyframes({ duration = 300, keyframes: keyframeValues, times, ease = 'easeInOut' }) {
        const easingFunctions = ((ease) => Array.isArray(ease) && 'number' != typeof ease[0])(ease)
      ...
      function getFinalKeyframe(
        ...
        return index && void 0 !== finalKeyframe ? finalKeyframe : resolvedKeyframes[index]
      }
      const transitionTypeMap = { decay: inertia, inertia, tween: keyframes, keyframes, spring }
      function replaceTransitionType(transition) {
        'string' == typeof transition.type && (transition.type = transitionTypeMap[transition.type])
      }
      class WithPromise {
        constructor() {
          this.updateFinished()
      ...
      class JSAnimation extends WithPromise {
        constructor(options) {
          ;(super(),
            ...
            (this.stop = () => {
              ...
              ;(motionValue && motionValue.updatedAt !== time.now() && this.tick(time.now()),
                (this.isStopped = !0),
        ...
        tick(timestamp, sample = !1) {
          ...
          ;(this.speed > 0
            ...
            sample ? (this.currentTime = timestamp) : this.updateTime(timestamp))
          ...
          isInDelayPhase ||
            ...
            (done =
              this.playbackSpeed >= 0 ? this.currentTime >= totalDuration : this.currentTime <= 0)
        ...
        set time(newTime) {
          ;((newTime = time_conversion_secondsToMilliseconds(newTime)),
            ...
            null === this.startTime || null !== this.holdTime || 0 === this.playbackSpeed
              ...
              : this.driver && (this.startTime = this.driver.now() - newTime / this.playbackSpeed),
            this.driver?.start(!1))
        }
        get speed() {
        ...
        set speed(newSpeed) {
          ...
          ;((this.playbackSpeed = newSpeed),
            hasChanged && (this.time = millisecondsToSeconds(this.currentTime)))
        }
        play() {
      ...
      const supportsScrollTimeline = memo(() => void 0 !== window.ScrollTimeline),
        supportsFlags = {}
      ...
      class NativeAnimation extends WithPromise {
        constructor(options) {
          if ((super(), (this.finishedTime = null), (this.isStopped = !1), !options)) return
          const {
            element,
            name,
            keyframes,
          ...
          ;((this.isPseudoElement = Boolean(pseudoElement)),
            ...
            (this.options = options),
            options.type)
          const transition = (function applyGeneratorOptions({ type, ...options }) {
      ...
      class NativeAnimationExtended extends NativeAnimation {
        ...
        updateMotionValue(value) {
          ...
          const sampleAnimation = new JSAnimation({ ...options, autoplay: !1 }),
            sampleTime = time_conversion_secondsToMilliseconds(this.finishedTime ?? this.time)
            ...
            (function canAnimate(keyframes, name, type, velocity) {
              ...
              return (
                ...
                ((function hasKeyframesChanged(keyframes) {
                  ...
                  for (let i = 0; i < keyframes.length; i++) if (keyframes[i] !== current) return !0
                })(keyframes) ||
      ...
      const animateMotionValue =
        ...
        (onComplete) => {
          ...
          })(valueTransition) || Object.assign(options, getDefaultTransition(name, options)),
            options.duration &&
          ...
          let shouldSkip = !1
          if (
            ((!1 === options.type || (0 === options.duration && !options.repeatDelay)) &&
              (makeAnimationInstant(options), 0 === options.delay && (shouldSkip = !0)),
            (MotionGlobalConfig.instantAnimations || MotionGlobalConfig.skipAnimations) &&
              ((shouldSkip = !0), makeAnimationInstant(options), (options.delay = 0)),
            (options.allowFlatten = !valueTransition.type && !valueTransition.ease),
            shouldSkip && !isHandoff && void 0 !== value.get())
          ) {
            const finalKeyframe = (function get_final_keyframe_getFinalKeyframe(
              keyframes,
              { repeat, repeatType = 'loop' },
              finalKeyframe
            ) {
      ...
      function shouldBlockAnimation({ protectedKeys, needsAnimating }, key) {
        const shouldBlock = protectedKeys.hasOwnProperty(key) && !0 !== needsAnimating[key]
        ...
        for (const key in target) {
          ...
          if (window.MotionHandoffAnimation) {
            ...
            if (appearId) {
              ...
              null !== startTime && ((valueTransition.startTime = startTime), (isHandoff = !0))
            }
          }
      ...
      function calcChildStagger(
        ...
        const index = Array.from(children)
          ...
          maxStaggerDuration = (numChildren - 1) * staggerChildren
        return 'function' == typeof delayChildren
      ...
      function animateVariant(visualElement, variant, options = {}) {
        const resolved = resolveVariant(
          visualElement,
          variant,
          'exit' === options.type ? visualElement.presenceContext?.custom : void 0
        )
                      ...
                      (child.notify('AnimationStart', variant),
                        animations.push(
                          animateVariant(child, variant, {
                            ...
                            delay:
                              delay +
                              ('function' == typeof delayChildren ? 0 : delayChildren) +
                              calcChildStagger(
          ...
          Promise.all(
            animations.map(({ animation, options }) =>
              (function animateVisualElement(visualElement, definition, options = {}) {
                let animation
                if (
                  (visualElement.notify('AnimationStart', definition), Array.isArray(definition))
                ) {
                ...
                ...definitionList.map((animation) => {
                  ...
                  if (
                    ...
                    const { parent } = visualElement,
                      parentVariant = resolveVariant(parent, animation)
      ...
      function calcAxisDelta(delta, source, target, origin = 0.5) {
        ;((delta.origin = origin),
          ...
          ((delta.scale >= 0.9999 && delta.scale <= 1.0001) || isNaN(delta.scale)) &&
            (delta.scale = 1),
          ((delta.translate >= -0.01 && delta.translate <= 0.01) || isNaN(delta.translate)) &&
            (delta.translate = 0))
      }
      ...
      class VisualElementDragControls {
            ...
            originEvent,
            {
              ...
              onStart: (event, info) => {
                ...
                ;((this.latestPointerEvent = event),
                  ...
                  onDragStart && frame_frame.postRender(() => onDragStart(event, info)),
        ...
        stop(event, panInfo) {
          ...
          if ((this.cancel(), !isDragging || !finalPanInfo || !finalEvent)) return
          const { velocity } = finalPanInfo
          this.startAnimation(velocity)
          const { onDragEnd } = this.getProps()
          onDragEnd && frame_frame.postRender(() => onDragEnd(finalEvent, finalPanInfo))
        }
        cancel() {
          this.isDragging = !1
            ...
            prevConstraints !== this.constraints &&
              ...
              eachAxis((axis) => {
                !1 !== this.constraints &&
                  ...
                  (this.constraints[axis] = (function rebaseAxisConstraints(layout, constraints) {
        ...
        resolveRefConstraints() {
          ...
          })(constraintsElement, projection.root, this.visualElement.getTransformPagePoint())
          let measuredConstraints = (function calcViewportConstraints(layoutBox, constraintsBox) {
            return {
        ...
        startAxisValueAnimation(axis, transition) {
          ...
          return (
            ...
            axisValue.start(
              animateMotionValue(axis, axisValue, 0, transition, this.visualElement, !1)
            )
          )
        }
        stopAnimation() {
      ...
      const correctBorderRadius = {
        ...
        correctBoxShadow = {
          correct: (latest, { treeScale, projectionDelta }) => {
            ...
            return (
              'number' == typeof shadow[2 + offset] && (shadow[2 + offset] /= averageScale),
              'number' == typeof shadow[3 + offset] && (shadow[3 + offset] /= averageScale),
              template(shadow)
            )
          },
        }
          ...
          ;(!(function addScaleCorrector(correctors) {
            for (const key in correctors)
              ((scaleCorrectors[key] = correctors[key]),
                isCSSVariableName(key) && (scaleCorrectors[key].isCSSVariable = !0))
      ...
      var is_object = __webpack_require__('./node_modules/motion-utils/dist/es/is-object.mjs')
      ...
      function delay(callback, timeout) {
        ...
        return (frame_frame.setup(checkElapsed, !0), () => cancelFrame(checkElapsed))
      }
      ...
      function removeAxisTransforms(
        ...
        !(function removeAxisDelta(
          ...
          percent.test(translate) &&
            ...
            (translate =
              mixNumber(sourceAxis.min, sourceAxis.max, translate / 100) - sourceAxis.min))
      ...
      const metrics = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 },
        transformAxes = ['', 'X', 'Y', 'Z']
      ...
      function cancelTreeOptimisedTransformAnimations(projectionNode) {
        if (
          ((projectionNode.hasCheckedOptimisedAppear = !0), projectionNode.root === projectionNode)
        )
          return
        ...
        return class ProjectionNode {
          ...
          mount(instance) {
            ...
            if (
              ...
              this.root.hasTreeAnimated && (layout || layoutId) && (this.isLayoutDirty = !0),
              attachResizeListener)
            ) {
              let cancelDelay,
                innerWidth = 0
                ...
                this.addEventListener(
                  ...
                  ({ delta, hasLayoutChanged, hasRelativeLayoutChanged, layout: newLayout }) => {
                    ...
                    const layoutTransition =
                      ...
                      hasOnlyRelativeTargetChanged = !hasLayoutChanged && hasRelativeLayoutChanged
                    if (
          ...
          measurePageBox() {
            const { visualElement } = this.options
            if (!visualElement) return { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } }
            const box = visualElement.measureViewportBox()
            if (!(this.scroll?.wasRoot || this.path.some(checkNodeWasScrollRoot))) {
              const { scroll } = this.root
              scroll &&
                (translateAxis(box.x, scroll.offset.x), translateAxis(box.y, scroll.offset.y))
            }
            return box
          }
          removeElementScroll(box) {
            const boxWithoutScroll = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } }
            if ((copyBoxInto(boxWithoutScroll, box), this.scroll?.wasRoot)) return boxWithoutScroll
            for (let i = 0; i < this.path.length; i++) {
              const node = this.path[i],
                { scroll, options } = node
              node !== this.root &&
          ...
          applyTransform(box, transformOnly = !1) {
            const withTransforms = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } }
          ...
          removeTransform(box) {
            const boxWithoutTransform = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } }
          ...
          calcProjection() {
            ...
            let canSkip = !0
            if (
              ((this.isProjectionDirty || this.parent?.isProjectionDirty) && (canSkip = !1),
            ...
            ;(!(function applyTreeDeltas(box, treeScale, treePath, isSharedTransition = !1) {
              ...
              ;(treeScale.x < 1.0000000000001 && treeScale.x > 0.999999999999 && (treeScale.x = 1),
                treeScale.y < 1.0000000000001 && treeScale.y > 0.999999999999 && (treeScale.y = 1))
            })(this.layoutCorrected, this.treeScale, this.path, isShared),
              !lead.layout ||
                lead.target ||
                (1 === this.treeScale.x && 1 === this.treeScale.y) ||
                ((lead.target = lead.layout.layoutBox),
                (lead.targetWithTransforms = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } })))
            const { target } = lead
            target
          ...
          setAnimationOrigin(delta, hasOnlyRelativeTargetChanged = !1) {
            ...
            const relativeLayout = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } },
              ...
              (this.mixTargetDelta = (latest) => {
                ...
                ;(mixAxisDelta(targetDelta.x, delta.x, progress),
                  ...
                  this.relativeTarget &&
                    ...
                    })(this.relativeTarget, this.relativeTargetOrigin, relativeLayout, progress),
                    prevRelativeTarget &&
                      ...
                      (this.isProjectionDirty = !1),
                    prevRelativeTarget ||
                      (prevRelativeTarget = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } }),
            ...
            ;(this.notifyListeners('animationStart'),
              ...
              (this.pendingAnimation = frame_frame.update(() => {
                ;((globalProjectionState.hasAnimatedSinceResize = !0),
                  ...
                  (this.currentAnimation = (function animateSingleValue(value, keyframes, options) {
          ...
          applyTransformsToTarget() {
            ...
            if (targetWithTransforms && target && layout) {
              if (
                ...
                target = this.target || { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } }
          ...
          applyProjectionStyles(targetStyle, styleProp) {
            ...
            if (!this.isVisible) return void (targetStyle.visibility = 'hidden')
            const transformTemplate = this.getTransformTemplate()
            if (this.needsReset)
              return (
                (this.needsReset = !1),
            ...
            let transform = (function buildProjectionTransform(delta, treeScale, latestTransform) {
              let transform = ''
            ...
            ;(transformTemplate && (transform = transformTemplate(valuesToRender, transform)),
            ...
            for (const key in scaleCorrectors) {
              ...
              const { correct, applyTo, isCSSVariable } = scaleCorrectors[key],
                corrected =
                  'none' === transform ? valuesToRender[key] : correct(valuesToRender[key], lead)
              if (applyTo) {
          ...
          if (!node.resumeFrom) {
            ...
            if (relativeParent && !relativeParent.resumeFrom) {
              ...
              if (parentSnapshot && parentLayout) {
                const relativeSnapshot = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } }
            ...
            Feature: class PanGesture extends Feature {
              ...
              createPanHandlers() {
                ...
                return {
                  ...
                  onEnd: (event, info) => {
                    ;(delete this.session,
                      onPanEnd && frame_frame.postRender(() => onPanEnd(event, info)))
                  },
                }
              }
              mount() {
      ...
      function setupGesture(elementOrSelector, options) {
        const elements = (function resolveElements(elementOrSelector, scope, selectorCache) {
      ...
      function handleHoverEvent(node, event, lifecycle) {
        ...
        callback && frame_frame.postRender(() => callback(event, extractEventInfo(event)))
      }
      ...
      function handlePressEvent(node, event, lifecycle) {
        ...
        const callback = props['onTap' + ('End' === lifecycle ? '' : lifecycle)]
        callback && frame_frame.postRender(() => callback(event, extractEventInfo(event)))
      }
      ...
      function observeIntersection(element, options, callback) {
        const rootInteresectionObserver = (function initIntersectionObserver({ root, ...options }) {
            ...
            hover: {
              Feature: class HoverGesture extends Feature {
                mount() {
                  const { current } = this.node
                  current &&
                    (this.unmount = (function hover(elementOrSelector, onHoverStart, options = {}) {
                      const [elements, eventOptions, cancel] = setupGesture(
                        ...
                        onPointerEnter = (enterEvent) => {
                          ...
                          if ('function' != typeof onHoverEnd || !target) return
    ...
    './node_modules/motion-dom/dist/es/utils/is-html-element.mjs': (
      ...
      function isHTMLElement(element) {
        return (
          (0, motion_utils__WEBPACK_IMPORTED_MODULE_0__.G)(element) && 'offsetHeight' in element
        )
      }
    },
    './node_modules/motion-utils/dist/es/is-object.mjs': (
