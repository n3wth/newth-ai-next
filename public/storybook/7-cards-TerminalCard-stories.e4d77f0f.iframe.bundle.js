...
;(self.webpackChunknewth_ai_next = self.webpackChunknewth_ai_next || []).push([
  [475],
  {
    ...
    './stories/7-cards/TerminalCard.stories.tsx': (
      ...
      const TerminalCard = (0, react.memo)(function TerminalCard({
        variant = 'default',
        className,
        children,
        hover = !0,
        ...
        const classes = (0, design_system.cn)(
          design_system.iN.card[variant].base,
          hover && design_system.iN.card[variant].hover,
          className
        )
            ...
            children: (0, jsx_runtime.jsxs)('div', {
              ...
              children: [
                (0, jsx_runtime.jsxs)('div', {
                  ...
                  children: [
                    (0, jsx_runtime.jsx)('span', { className: 'text-gray-400', children: 'CPU:' }),
                    (0, jsx_runtime.jsx)('span', { className: 'text-green-400', children: '12%' }),
                  ],
                }),
                (0, jsx_runtime.jsxs)('div', {
                  className: 'flex justify-between',
                  children: [
                    ...
                    (0, jsx_runtime.jsx)('span', { className: 'text-yellow-400', children: '67%' }),
                  ],
                }),
                (0, jsx_runtime.jsxs)('div', {
                  className: 'flex justify-between',
                  children: [
                    (0, jsx_runtime.jsx)('span', { className: 'text-gray-400', children: 'Disk:' }),
                    (0, jsx_runtime.jsx)('span', { className: 'text-red-400', children: '89%' }),
                  ],
                }),
              ],
            }),
