...
;(self.webpackChunknewth_ai_next = self.webpackChunknewth_ai_next || []).push([
  [237],
  {
    './components/WarpBackground.tsx': (
      ...
      __webpack_require__.d(__webpack_exports__, { N: () => WarpBackground })
      ...
      const AnimatedShape = react__WEBPACK_IMPORTED_MODULE_3__.memo(
        ({ x, y, delay, type, colorSet }) => {
          const colors = [
            ...
            shapeVariants = {
              cube: (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
              ...
              pyramid: (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
                framer_motion__WEBPACK_IMPORTED_MODULE_2__.P.div,
                {
                  className: 'absolute pointer-events-none',
                  style: { left: `${x}%`, top: `${y}%` },
              ...
              sphere: (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
                framer_motion__WEBPACK_IMPORTED_MODULE_2__.P.div,
                {
                  className: 'absolute pointer-events-none',
              ...
              helix: (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
                framer_motion__WEBPACK_IMPORTED_MODULE_2__.P.div,
                {
                  className: 'absolute pointer-events-none',
              ...
              prism: (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
                framer_motion__WEBPACK_IMPORTED_MODULE_2__.P.div,
                {
                  className: 'absolute pointer-events-none',
              ...
              torus: (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
                framer_motion__WEBPACK_IMPORTED_MODULE_2__.P.div,
                {
                  className: 'absolute pointer-events-none',
              ...
              grid: (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
                framer_motion__WEBPACK_IMPORTED_MODULE_2__.P.div,
                {
                  className: 'absolute pointer-events-none',
      ...
      const seededRandom = (seed) => {
        ...
        WarpBackground = react__WEBPACK_IMPORTED_MODULE_3__.memo(
          ({ children, className, ...props }) => {
            const shapes = (0, react__WEBPACK_IMPORTED_MODULE_3__.useMemo)(() => {
              const shapeArray = [],
