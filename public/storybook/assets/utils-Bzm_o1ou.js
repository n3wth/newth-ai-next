...
const ne = '-',
  ...
  we = (e, n) => {
    ...
    const m = e.join(ne)
    return n.validators.find(({ validator: l }) => l(m))?.classGroupId
  },
  fe = /^\[(.+)\]$/,
  Ge = (e) => {
    if (fe.test(e)) {
  ...
  Fe = (e) => ({ cache: Ne(e.cacheSize), parseClassName: Ve(e), sortModifiers: Oe(e), ...Re(e) }),
  _e = /\s+/,
  Be = (e, n) => {
    const {
        parseClassName: r,
  ...
  lo = () => {
    ...
    return {
      ...
      classGroups: {
        ...
        z: [{ z: [S, 'auto', s, t] }],
        basis: [{ basis: [L, 'full', 'auto', u, ...c()] }],
        'flex-direction': [{ flex: ['row', 'row-reverse', 'col', 'col-reverse'] }],
        'flex-wrap': [{ flex: ['nowrap', 'wrap', 'wrap-reverse'] }],
        flex: [{ flex: [d, L, 'auto', 'initial', 'none', t] }],
        grow: [{ grow: ['', d, s, t] }],
        shrink: [{ shrink: ['', d, s, t] }],
        ...
        'text-decoration-thickness': [{ decoration: [d, 'from-font', 'auto', s, R] }],
