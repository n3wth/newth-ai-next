        ...
        children: e.jsxs('div', {
          ...
          children: [
            ...
            e.jsx('div', {
              ...
              ].map(({ name: a, value: i, className: m }) =>
                e.jsxs(
                  'div',
                  {
                    ...
                    children: [
                      ...
                      e.jsx('div', { className: `${m} h-8 bg-violet-500 rounded` }),
                      e.jsx('span', { className: 'text-gray-500 text-xs font-mono', children: i }),
                    ],
                  },
                  a
                )
                    ...
                    e.jsxs('div', {
                      ...
                      children: [
                        e.jsx('div', {
                          ...
                          children: e.jsx('div', {
                            className: '-mx-4 bg-violet-500 rounded p-3 text-xs text-center',
                            children: '-mx-4',
                          }),
                        }),
                        e.jsx('div', {
                          ...
                          children: e.jsx('div', {
                            className: '-mt-8 bg-violet-500 rounded p-3 text-xs text-center',
                            children: '-mt-8',
                          }),
                        }),
                      ],
                            ...
                            e.jsx('div', {
                              ...
                              children: [1, 2, 3, 4].map((a) =>
                                e.jsx(
                                  'div',
                                  {
                                    className: 'bg-violet-500 rounded p-4 text-xs text-center',
                                    children: 'Item',
                                  },
                                  a
                                )
                    ...
                    e.jsxs('div', {
                      ...
                      children: [
                        ...
                        e.jsxs('div', {
                          className: 'space-y-8',
                          children: [
                            e.jsx('div', { className: 'h-8 bg-gray-700 rounded' }),
                            e.jsx('div', { className: 'h-8 bg-gray-700 rounded' }),
                          ],
                        }),
                      ],
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex gap-2">
                  {[1, 2, 3, 4].map(i => <div key={i} className="bg-violet-500 rounded p-4 text-xs text-center">Item</div>)}
                </div>
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="grid grid-cols-4 gap-4">
                  {[1, 2, 3, 4, 5, 6, 7, 8].map(i => <div key={i} className="bg-violet-500 rounded p-4 text-xs text-center">Cell</div>)}
                </div>
              </div>
              <div>
...
const v = ['Scale', 'Padding', 'Margin', 'Gap', 'SpaceUtilities']
export {
  t as Gap,
  n as Margin,
  d as Padding,
